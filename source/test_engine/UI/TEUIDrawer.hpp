...
private:
  ...
  void draw_image_in_rect(Image *, const gm::Rect &,
                          const gm::Color &color = gm::Color::white) override;
  void draw_path_in_rect(ui::PathData *, const gm::Rect &) override;

  ui::PathData *initialize_path_data(gm::PointsPath *, const gm::Color &,
                                     ui::PathData::DrawMode draw_mode) override;
